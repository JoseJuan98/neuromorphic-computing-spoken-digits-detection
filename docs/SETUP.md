...
If conda was used to create the environment, it created a virtual environment called `neuromorphic-computing-spoken-digits-detection`. To activate it:

```bash
conda activate neuromorphic-computing-spoken-digits-detection
```
